      ...
      >
        ...
        <div className="relative z-10">
          ...
          <div className="space-y-4">
            <button className="w-full bg-white text-black py-4 rounded-full text-sm tracking-widest font-medium hover:bg-neutral-200 transition-colors flex items-center justify-center gap-2 group">
